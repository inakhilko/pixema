  ...
  return (
    <div className="filters">
      <div className="filters__top=block">
        ...
        <button className="filters__close">
          <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
        ...
        <h4 className="filters__sub-title">Sort by</h4>
        <ButtonBlock buttonBlockData={filtersButtonBlockData} />
